...
base_exp_dir=./exp/test-${dataset}-f$fstride-t$tstride-impTrue-aspTrue-b$batch_size-lr1e-5-test
...
CUDA_CACHE_DISABLE=1 python -W ignore ../../src/test.py --model ${model} --dataset ${dataset} \
